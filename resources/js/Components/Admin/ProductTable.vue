<template>
    <div>
        ...
        <!-- 4x4 Grid View -->
        <div v-else-if="viewMode === 'grid-4'" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div
                v-for="product in products"
                :key="product.id"
                @click="$emit('preview', product.id)"
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <span
                            ...
                            :title="product.sold_out ? 'Sold Out' : 'Available'"
                        ></span>
                    </div>
