<template>
    ...
    >
        ...
        <div v-if="product.has_active_discount" class="absolute top-2 right-2 z-10 transform rotate-12">
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 text-white text-xs font-bold px-3 py-1 rounded-lg shadow-lg border-2 border-orange-400">
        ...
        <div class="product-content p-4 flex-1 flex flex-col">
            <h3 class="product-title text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors">
                {{ product.title }}
            </h3>
            
            <p v-if="product.description" class="text-sm text-gray-600 mt-1 line-clamp-2 min-w-0">
                {{ product.description }}
            </p>
            ...
            <div class="flex items-center justify-between mt-3 flex-wrap gap-2">
                ...
                <span class="text-sm text-blue-600 group-hover:text-blue-700 font-medium">
                    Vedi Dettagli →
                </span>
            </div>
