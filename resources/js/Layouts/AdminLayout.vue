    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <div class="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white shadow-md safe-area-top">
            <div class="flex items-center justify-between px-3 sm:px-4 py-3 h-14">
                <div class="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
                    <h1 class="text-base sm:text-lg font-bold logo-jd truncate">JDOutlet Admin</h1>
        ...
        >
            <div class="flex flex-col h-full overflow-hidden">
                <div class="flex items-center justify-center h-16 lg:h-20 shadow-md flex-shrink-0 bg-jd-button">
                    <h1 class="text-xl lg:text-2xl font-bold text-white">JDOutlet Admin</h1>
                </div>
        ...
        <!-- Main content -->
        <main class="lg:pl-64 pt-14 lg:pt-0 safe-area-bottom">
